...
<div class="not-prose my-6 rounded-lg border overflow-hidden" style="border-color: var(--color-border);">
  <div class="px-4 py-2.5 font-semibold text-sm" style="background-color: var(--color-card); border-bottom: 1px solid var(--color-border);">モデル切り替えの簡単さ</div>
  <div class="p-4 text-sm space-y-3" style="color: var(--color-foreground);">
    <p><strong>OpenAI:</strong></p>
    <code class="block px-3 py-1 rounded text-xs" style="background-color: var(--color-code-bg);">llm = ChatOpenAI(model="gpt-4o")</code>
    <p class="text-center" style="color: var(--color-muted);">&#8595; 1行変更するだけ</p>
    <p><strong>Ollama:</strong></p>
    <code class="block px-3 py-1 rounded text-xs" style="background-color: var(--color-code-bg);">llm = ChatOllama(model="gemma3:1b")</code>
    <p class="mt-3 font-semibold" style="color: var(--color-accent);">残りのチェーンコードは変更不要！</p>
  </div>
</div>
